...
class I18n {
  ...
  /// `Favorite Strings`
  String get strings_pageTitle {
    return Intl.message(
      'Favorite Strings',
      name: 'strings_pageTitle',
      desc: '',
      args: [],
    );
  }
  ...
  /// `All`
  String get strings_allTab_title {
    return Intl.message(
      'All',
      name: 'strings_allTab_title',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Favorites`
  String get strings_favoritesTab_title {
    return Intl.message(
      'Favorites',
      name: 'strings_favoritesTab_title',
      desc: '',
      args: [],
    );
  }
  ...
  String get strings_favoritesTab_emptyList {
    return Intl.message(
      'Your favorite list is empty',
      name: 'strings_favoritesTab_emptyList',
      desc: '',
      args: [],
    );
  }
